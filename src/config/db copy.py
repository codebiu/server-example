...
dataBaseSqliteDefault = DataBaseSqlite(SQLALCHEMY_DATABASE_URL)
dataBaseSqliteDefault.connect()
# 当前数据引擎
engine: AsyncEngine = dataBaseSqliteDefault.engine
sessionLocalUse = dataBaseSqliteDefault.sessionLocal
