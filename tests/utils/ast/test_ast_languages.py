...
@pytest.fixture
def ast_languages_instance():
    """提供一个 AstLanguages 类的实例"""
    return AstLanguages()

def test_get_parser(ast_languages_instance):
...
def test_code2tree(ast_languages_instance):
...
def test_unsupported_language(ast_languages_instance):
